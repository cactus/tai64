...
func TestRoundTrip(t *testing.T) {
	var tests = map[string]time.Time{
		...
		"second at tai swap":         time.Date(1969, 12, 31, 23, 59, 50, 00, time.UTC),
		...
		"second at unix epoc":        time.Date(1970, 01, 01, 00, 00, 00, 00, time.UTC),
		"second after unix epoc":     time.Date(1970, 01, 01, 00, 00, 01, 00, time.UTC),
		"second before tai-utc epoc": time.Date(1970, 01, 01, 00, 00, 9, 00, time.UTC),
		"second at tai-utc epoc":     time.Date(1970, 01, 01, 00, 00, 10, 00, time.UTC),
